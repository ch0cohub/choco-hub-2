...
def test_selenium2():
    ...
    try:
        ...
        assert num_authors_select.first_selected_option.text == 'Proyecto individual', 'Filtro de número de autores no aplicado'
        time.sleep(1)  # Esperamos a que se aplique el filtro

        # Paso 3: Filtrar por validación de archivos UVL
        search_by_uvl_validation = driver.find_element(By.XPATH, "//*[@id='uvl_validation']")
        assert search_by_uvl_validation.is_displayed(), 'Botón de validación de archivos UVL no encontrado'
