...
def test_login_logout_flow(test_client):
    ...
    ), "The user is still authenticated after logout."
...
def test_protected_route_access(test_client, test_client_not_logged_in):
    ...
    ), "Protected route should not be accessible without logging in."
    ...
    ), "Protected route should be accessible after logging in."
