...
class SignupvalidationService(BaseService):
    def __init__(self):
        ...
        self.CONFIRM_EMAIL_TOKEN_MAX_AGE = int(os.getenv('CONFIRM_EMAIL_TOKEN_MAX_AGE', 3600))
    ...
    def send_confirmation_email(self, user_email):
        ...
        confirmation_url = url_for("signupvalidation.confirm_user", token=token, _external=True)
